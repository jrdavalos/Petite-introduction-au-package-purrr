...
| Packages   | Fonctions                              |
|------------|----------------------------------------|
| **Base R** | list -  for - mean - sum               |
| **dplyr**  | across                                 |
| **purrr**  | map - imap - map2 - pmap - in_parallel |
| **mirai**  | deamon                                 |
...
### Exemple 6bis : moyenne pondérée avec `dplyr` (voir le détail du fonctionnement dans la fiche sur les recodages multiples)
...
### Exemple 7 : coller noms d'objets et leurs valeurs
...
### Exemple 8 : importation de fichiers csv annuels
```{r}
